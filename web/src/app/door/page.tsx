"use client";
// import { Comment } from "./_components/v4/Comment";
import type { Comment as CommentType } from "./_components/v4/types";
import Comment from "./_components/v5/comment";
// import UserAvatar from "./_components/v4/user-avatar";
