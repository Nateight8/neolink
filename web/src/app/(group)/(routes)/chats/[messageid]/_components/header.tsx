        ...
        <div className="flex flex-1 items-center mx-3">
          <div className="relative">
            <Avatar className="size-8 border border-cyan-500">
              <AvatarImage
                src={user?.avatarUrl || ""}
                alt={user?.username || user?.fullName || user?.handle || "User"}
              />
          ...
          <div className="ml-3">
            ...
            <div className="flex flex-col">
              <div className="flex items-center text-lg font-semibold">
                <span className="text-cyan-400 whitespace-nowrap overflow-hidden text-ellipsis max-w-[7ch] sm:max-w-full uppercase font-mono">
                  {user?.handle}
                </span>
              </div>
            </div>
